...
public sealed record InventoryStockResponse(Guid Id, Guid ResourceId, decimal QuantityOnHand, decimal ReservedQuantity, decimal AvailableQuantity, decimal LowStockThreshold);
...
public sealed record ResourceReservationResponse(Guid Id, Guid InventoryStockId, Guid RequestedByUserId, decimal Quantity, ResourceReservationStatus Status, DateTime? ReleasedAt, string Purpose);
